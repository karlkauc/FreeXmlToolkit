...
import org.fxt.freexmltoolkit.controls.v2.xmleditor.commands.XmlCommand;
...
public class XmlGridContextMenu {
    ...
    private ContextMenu buildContextMenu() {
        ...
        addMenu.setGraphic(createColoredIcon("bi-plus-circle", DesignTokens.ColorToken.SUCCESS)); // Green

        addElementItem = new MenuItem("Child Element");
        addElementItem.setGraphic(createColoredIcon("bi-code-slash", DesignTokens.ColorToken.SUCCESS)); // Green
        addElementItem.setOnAction(e -> addChildElement());

        addAttributeItem = new MenuItem("Attribute");
        addAttributeItem.setGraphic(createColoredIcon("bi-at", DesignTokens.ColorToken.WARNING)); // Yellow
        addAttributeItem.setOnAction(e -> addAttribute());

        addTextItem = new MenuItem("Text Content");
        addTextItem.setGraphic(createColoredIcon("bi-fonts", DesignTokens.ColorToken.INFO)); // Teal
        addTextItem.setOnAction(e -> addTextContent());

        addSiblingBeforeItem = new MenuItem("Sibling Before");
        addSiblingBeforeItem.setGraphic(createColoredIcon("bi-arrow-up", DesignTokens.ColorToken.SUCCESS)); // Green
        addSiblingBeforeItem.setOnAction(e -> addSiblingElement(true));

        addSiblingAfterItem = new MenuItem("Sibling After");
        addSiblingAfterItem.setGraphic(createColoredIcon("bi-arrow-down", DesignTokens.ColorToken.SUCCESS)); // Green
        ...
        renameItem.setGraphic(createColoredIcon("bi-pencil", DesignTokens.ColorToken.ACCENT)); // Orange
        ...
        duplicateItem.setGraphic(createColoredIcon("bi-files", DesignTokens.ColorToken.TEAL)); // Teal green
        ...
        copyItem.setGraphic(createColoredIcon("bi-clipboard", DesignTokens.ColorToken.NEUTRAL)); // Gray
        copyItem.setOnAction(e -> copyElement());
        copyItem.setAccelerator(new KeyCodeCombination(KeyCode.C, KeyCombination.CONTROL_DOWN));

        cutItem = new MenuItem("Cut");
        cutItem.setGraphic(createColoredIcon("bi-scissors", DesignTokens.ColorToken.ACCENT)); // Orange
        cutItem.setOnAction(e -> cutElement());
        cutItem.setAccelerator(new KeyCodeCombination(KeyCode.X, KeyCombination.CONTROL_DOWN));

        pasteItem = new MenuItem("Paste as Sibling");
        pasteItem.setGraphic(createColoredIcon("bi-clipboard-check", DesignTokens.ColorToken.NEUTRAL)); // Gray
        pasteItem.setOnAction(e -> pasteAsSibling());
        pasteItem.setAccelerator(new KeyCodeCombination(KeyCode.V, KeyCombination.CONTROL_DOWN));

        pasteAsChildItem = new MenuItem("Paste as Child");
        pasteAsChildItem.setGraphic(createColoredIcon("bi-clipboard-plus", DesignTokens.ColorToken.NEUTRAL)); // Gray
        ...
        copyCellContentItem.setGraphic(createColoredIcon("bi-clipboard-data", DesignTokens.ColorToken.INFO)); // Teal
        ...
        copyXPathItem.setGraphic(createColoredIcon("bi-diagram-3", DesignTokens.ColorToken.PURPLE)); // Purple
        ...
        copyNodeItem.setGraphic(createColoredIcon("bi-clipboard-data", DesignTokens.ColorToken.PURPLE)); // Purple
        ...
        goToDefinitionItem.setGraphic(createColoredIcon("bi-box-arrow-up-right", DesignTokens.ColorToken.INFO)); // Info/teal
        goToDefinitionItem.setOnAction(e -> goToDefinition());

        // === Move ===
        moveUpItem = new MenuItem("Move Up");
        moveUpItem.setGraphic(createColoredIcon("bi-arrow-up-circle", DesignTokens.ColorToken.NEUTRAL)); // Gray
        ...
        moveDownItem.setGraphic(createColoredIcon("bi-arrow-down-circle", DesignTokens.ColorToken.NEUTRAL)); // Gray
        ...
        expandAllItem.setGraphic(createColoredIcon("bi-arrows-expand", DesignTokens.ColorToken.PRIMARY)); // Blue
        expandAllItem.setOnAction(e -> expandAll());

        collapseAllItem = new MenuItem("Collapse All");
        collapseAllItem.setGraphic(createColoredIcon("bi-arrows-collapse", DesignTokens.ColorToken.PRIMARY)); // Blue
        collapseAllItem.setOnAction(e -> collapseAll());

        // === Sort (for table columns) ===
        sortMenu = new Menu("Sort Column");
        sortMenu.setGraphic(createColoredIcon("bi-sort-down", DesignTokens.ColorToken.PRIMARY)); // Blue

        sortAscendingItem = new MenuItem("Sort Ascending");
        sortAscendingItem.setGraphic(createColoredIcon("bi-sort-up", DesignTokens.ColorToken.SUCCESS)); // Green
        sortAscendingItem.setOnAction(e -> sortColumn(true));

        sortDescendingItem = new MenuItem("Sort Descending");
        sortDescendingItem.setGraphic(createColoredIcon("bi-sort-down-alt", DesignTokens.ColorToken.DANGER)); // Red
        ...
        deleteItem.setGraphic(createColoredIcon("bi-trash", DesignTokens.ColorToken.DANGER)); // Red

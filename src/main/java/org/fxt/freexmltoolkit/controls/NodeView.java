...
public class NodeView extends VBox {
    ...
    public NodeView(PreferencesFx preferencesFx, Preferences rootPane) {
    ...
    private void layoutParts() {
        ...
        if (rootPane.nightMode.get()) {
            getStylesheets().add(this.getClass().getResource("/darkTheme.css").toExternalForm());
        }
    }
    ...
    private void setupListeners() {
        rootPane.nightMode.addListener((observable, oldValue, newValue) -> {
            if (newValue) {
                getStylesheets().add(FxtGui.class.getResource("darkTheme.css").toExternalForm());
            } else {
                getStylesheets().remove(FxtGui.class.getResource("darkTheme.css").toExternalForm());
            }
        });
    }
}
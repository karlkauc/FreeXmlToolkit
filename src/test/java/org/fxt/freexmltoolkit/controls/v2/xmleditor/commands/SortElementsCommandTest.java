...
class SortElementsCommandTest {
    ...
    class SortabilityTests {
        ...
        void attributeColumnsShouldBeSortable() {
            RepeatingElementsTable table = new RepeatingElementsTable("item", testElements, 0, () -> {});
    ...
    class DataTypeDetectionTests {
        ...
        void shouldDetectDateColumns() {
            ...
            RepeatingElementsTable table = new RepeatingElementsTable("event", dateElements, 0, () -> {});

                            ...
                            <tbody>
                                ...
                                <xsl:if test="Portfolios">
                                    <xsl:variable name="diff"
                                                  select="TotalAssetValues/TotalAssetValue/TotalNetAssetValue/Amount[@ccy=$shareClassCcy] - sum(Portfolios/Portfolio/Positions/Position/TotalValue/Amount[@ccy=$shareClassCcy])"/>
                                    <tr>
                                        <xsl:choose>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <xsl:if test="@fromCcy eq @toCcy and number(.) ne 1">
                                                            <span id="ERROR_{generate-id(.)}"
                                                                  ...
                                                                  class="badge eg_status--red">ERROR: FX for same Currency not 1 {@fromCcy}/{@toCcy}: [{.}]
                                                            </span>
                                                        </xsl:if>
                                                    </div>
                                                </xsl:for-each>

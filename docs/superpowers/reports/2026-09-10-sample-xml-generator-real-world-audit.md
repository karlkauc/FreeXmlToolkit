...
> **The plan behind this report is closed (2026-09-12):** every sample of the corpus is valid in both generators and
> both modes, and two runs with the same seed are byte-identical. Four plan points stay open on purpose, none of them
> visible in the corpus (§30).
>
